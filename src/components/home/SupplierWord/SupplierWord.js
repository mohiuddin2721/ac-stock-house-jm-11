            ...
            <div className='mt-2'>
                <Accordion>
                    <Accordion.Item eventKey="0">
                        <Accordion.Header><span className='fw-bold text-success'>GREE</span></Accordion.Header>
                        <Accordion.Body>
                    ...
                    <Accordion.Item eventKey="1">
                        <Accordion.Header><span className='fw-bold text-success'>SAMSUNG</span></Accordion.Header>
                        <Accordion.Body>
                    ...
                    <Accordion.Item eventKey="2">
                        <Accordion.Header><span className='fw-bold text-success'>WALTON</span></Accordion.Header>
                        <Accordion.Body>
                    ...
                    <Accordion.Item eventKey="3">
                        <Accordion.Header><span className='fw-bold text-success'>HAIER</span></Accordion.Header>
                        <Accordion.Body>
